...
void GBK_Lib_Init(void)
{
	  ...
	  GPIO_InitTypeDef  GPIO_InitStructure;	
		...
		RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOB , ENABLE); //使能 PB,时钟
    ...
    GPIO_Init(GPIOB, &GPIO_InitStructure);             //初始化
		...
		GPIO_InitStructure.GPIO_Pin = GPIO_Pin_15 | GPIO_Pin_13 | GPIO_Pin_12 | GPIO_Pin_2 | GPIO_Pin_10;      //设置为推挽输出
