...
{	
	...
	JTAG_Set(SWD_ENABLE);           
	OLED_Init();
	uart3_init(230400);//激光雷达串口接收
    
    OLED_ShowString(1, 1, "STP-23L Laser");
            OLED_ShowString(3, 7, "mm");
    OLED_ShowString(4, 1, "2023.7.31");
...
void OLED_SHOW(void) 
{
		OLED_ShowString(2, 1, "Distance:");			/* 显示距离 */
        OLED_ShowNum(3, 1, distance, 5);    
